...
public class PersonneController {
    ...
    public ResponseEntity<List<Personne>> searchByNom(
    ...
    public ResponseEntity<List<Personne>> searchByPrenom(
    ...
    public ResponseEntity<List<Personne>> searchByVille(
    ...
    public ResponseEntity<List<Personne>> searchByKeyword(
